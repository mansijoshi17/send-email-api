...
const consumerAddress = "0x14Fb23e771F09BDAb11F4ED8e3BA37F80788B6fE"; // REPLACE this with your Functions consumer address
const subscriptionId = 1006; // REPLACE this with your subscription ID
...
const makeRequestMumbai = async () => {
  ...
  const provider = new ethers.BrowserProvider(rpcUrl);
